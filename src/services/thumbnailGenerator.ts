...
export class ThumbnailGenerator {
  ...
  constructor() {
    ...
    // Enviar el BASE_PATH (no origin) al worker para que pueda construir rutas correctas
    // En GitHub Pages será '/DAM/', en desarrollo será '/'
    const basePath = import.meta.env.BASE_URL || '/';
    this.worker.postMessage({ type: 'init', baseUrl: basePath });
